...
use whynot::text_renderer::{ConverterType, TextRendererConfig, TextRendererFactory};
...
async fn test_converter_configuration_options() {
    ...
    let html =
        r#"<p>Check out our <a href="https://example.com">amazing website</a> for more info!</p>"#;
